...
with open(budget_csv) as csv_file:
    ...
    #Verified my values. These two values are the same (initial returns 671099 and overall_profit returns 671099) - final returns is the last value in changes
    ...
    #Verified my output. total_change_profits returns the last value of the month
